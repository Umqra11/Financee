    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            role: "assistant",
            content:
                "Merhaba! 👋 Ben sizin kişisel finans danışmanınızım. Bana bu ayki harcamalarınız, bütçeniz veya tasarruf konularında sorular sorabilirsiniz. Örneğin:\n\n• Bu ay en çok hangi kategoride harcadım?\n• Bana tasarruf önerisi verir misin?\n• Aboneliklerimi azaltmalı mıyım?",
        },
    ]);
        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-2 md:p-4">
                    ...
                    {/* Panel */}
                    <div className="relative w-full max-w-md h-[85vh] md:h-[600px] bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
                        {/* Header */}
                        ...
                        <div className="px-4 py-3 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
                            <div className="flex items-center gap-2 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 px-3 py-1.5 focus-within:border-violet-400 dark:focus-within:border-violet-500 transition-colors">
                                <input
                                    ...
                                    disabled={isLoading}
                                    className="flex-1 bg-transparent border-none outline-none text-sm py-2 text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400"
                                />
                                <button
                                    onClick={handleSend}
                            ...
                            <p className="text-[10px] text-zinc-400 mt-2 text-center">
                                Verileriniz gizli kalır. DeepSeek V4 ile çalışır.
                            </p>
                        </div>
                    </div>
                </div>
